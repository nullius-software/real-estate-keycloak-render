...
CMD ["start", "--optimized", "--http-host=0.0.0.0", "--hostname=real-estate-keycloak-render.onrender.com", "--db-url=$KC_DB_URL", "--db-username=$KC_DB_USERNAME", "--db-password=$KC_DB_PASSWORD"]
