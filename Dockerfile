...
CMD ["start", "--optimized", "--http-host=0.0.0.0", "--hostname=real-estate-keycloak-render.onrender.com", "--hostname-strict-https=true", "-Dquarkus.datasource.jdbc.acquisition-timeout=60s", "--cache=local"]
