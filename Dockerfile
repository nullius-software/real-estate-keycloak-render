...
CMD ["start", "--optimized", "--http-host=0.0.0.0", "--hostname=real-estate-keycloak-render.onrender.com", "--proxy-headers=forwarded", "-Dquarkus.datasource.jdbc.acquisition-timeout=60s", "--cache=local"]
