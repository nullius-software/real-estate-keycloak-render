...
CMD ["start", "--optimized", "--http-host=0.0.0.0", "--hostname=real-estate-keycloak-render.onrender.com", "-Dquarkus.datasource.jdbc.acquisition-timeout=60s", "--cache=local", "--auto-build"]
